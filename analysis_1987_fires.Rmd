...
Whats the distribution in how much % tree canopy cover changed throughout the regeneration trajectory?
```{r}
df %>%
  #filter(burnSev > 1) %>%
  filter(clusterID %in% clusters_with_more_than8_pixels) %>%
...
Analyzing the effect of planting trees on the future physiognomic class in fire-affected pixels.
